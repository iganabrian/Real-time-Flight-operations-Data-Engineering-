...
def run_silver_transform(**context):
    ...
    if not bronze_file:
        raise ValueError('Bronze file path not found in Xcoms')
    ...
    df_raw.columns = [
        'icao24', 'callsign', 'origin_country', 'time_position', 'last_contact', 'longitude', 'latitude', 'baro_altitude', 'on_ground',
